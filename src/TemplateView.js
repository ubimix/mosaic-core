...
var TemplateView = Mosaic.Class.extend({
    ...
    /**
     * This is a default rendering method which is called if a method referenced
     * in the "data-render" attribute was not found.
     */
    ...
    /**
     * Default method used to handle events for which no specific handlers were
     * defined.
     */
     ...
     * elements containing "data-render" attributes and calls functions Mosaic *
     * referenced by this attribute. When the rendering process is finished then
     * this method calls all functions referenced by the "data-rendered"
     * attribute. Referenced functions should be defined in this view and they
     * has to accept one parameter - a reference to the rendered element.
     */
    renderElement : function(elm, render) {
        ...
        _.each(list, function(e) {
            this._callReferencedMethod(e, 'data-rendered', 'renderedDefault');
        }, this);
    },

    /**
     * Binds event listeners to elements marked by "data-action-xxx" attributes
     * (where "xxx" is the name of the action). The value of this action
     * attributes should reference event listeners defined in this view.
     * Example: <code>&lt;div data-action-click="sayHello">Hello&lt;/div></code>
     */
    ...
    /**
     * This method renders this view. It performs the following actions: 1) it
     * takes the topmost element of this class (using the "getElement" method)
     * 2) If there is a "template" field defined in this object then it is used
     * as a source for the underscore#template method to render the content; the
     * result of template rendering is appended to the view's element. 3) This
     * method calls all functions referenced in the "data-render" fields 4)
     * After rendering it calls functions referenced in the "data-rendered"
     * element attributes (to finalize the rendering process). 5) It attaches
     * event listeners referenced by the "data-action-xxx" attributes.
     */
    render : function() {
        var that = this;
    ...
    /**
     * This internal method renders the specified element. It is called by the
     * public "renderElement" method. This method seeks all elements containing
     * "data-render" attributes and calls functions referenced by this
     * attribute. When the rendering process is finished then this method calls
     * all functions referenced by the "data-rendered" attribute. Referenced
     * functions should be defined in this view and they has to accept one
    ...
    /**
     * Binds event listeners referenced in "data-action-xxx" element attributes
     * (where "xxx" is "click", "mouseover", "mouseout", "focus", "blur",
     ...
     * "render" method (see the description in this method). This method does
     * not fires any events.
     */
    _render : function() {
        var that = this;
...
/**
 * Extends the specified TemplateView object with the HTML content defined in
 * the given element and with methods defined in "script" elements marked by
 * attributes "data-type" equal to "methods" (for instance methods) and "const"
 * for static methods.
 */
