...
var PopupPanel = React
        .createClass({
            ...
            componentDidMount : function() {
                ...
                this._updatePopupHeight = _.debounce(this._updatePopupHeight,
                        10);
            ...
            _updatePopupHeight : function() {
                ...
                var contentPosition = this._getPosition(innerBorderElm,
                        outerBorderElm);
                ...
                if (!isNaN(height) && this.state.maxHeight !== height) {
                    ...
                    setTimeout(function() {
                        ...
                        var dialogHeight = outerBorderElm.offsetHeight;
                        var pos = Math
                                .round((containerHeight - dialogHeight) / 2);
                        pos = Math.max(pos, 0);
