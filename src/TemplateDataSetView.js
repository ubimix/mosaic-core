...
/**
 * This view automatically listens modifications in a data set specified as a
 * constructor parameter and builds views for each entry in this data set. To
 * append all
 */
var TemplateDataSetView = TemplateView.extend(DataSetView.prototype, {
     ...
     * _.functions(TemplateDataSetView.prototype)); Updates a view in the
     * specified index entry. This method should be overloaded in subclasses.
     */
